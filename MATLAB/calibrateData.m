function [acc, gyro, mag] = calibrateData(source)
...
%% Build raw matrices
accRaw{1}  = [R.accelX,   R.accelY,   R.accelZ]; % Board IMU
accRaw{2}  = [R.accelX_1, R.accelY_1, R.accelZ_1]; % Other IMU # 1
accRaw{3}  = [R.accelX_2, R.accelY_2, R.accelZ_2]; % Other IMU # 2
